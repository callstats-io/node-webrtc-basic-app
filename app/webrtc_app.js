...
//Constraints for video to be used in getUserMedia
var constraints = {
  audio: true,
  video: true
};

//get the localvideo elememnt by id name
var localVideo = document.querySelector('#localVideo');
var remoteVideo;
remoteVideo = document.getElementById("remoteVideo");
//sucess callback function for getUserMedia
...
function doAnswer() {
  ...
  setRemoteVideo("user1",function(status){});
}
